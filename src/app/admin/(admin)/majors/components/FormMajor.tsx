...
import { FormMajorValues } from "./DialogAddMajor";
type FormMajorProps = {
  open: boolean;
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
  form: any;
  onSubmit: (values: FormMajorValues) => void;
  isLoading: boolean;
  title: string;
  description: string;
        ...
        <Form {...form}>
          ...
          >
            <FormFieldComponent
              ...
              icon={null}
              requrie={true}
              label="Tên lĩnh vực công việc"
            >
              {(field) => (
                <Input placeholder="Nhập tên lĩnh vực công việc" {...field} />
              )}
            </FormFieldComponent>
