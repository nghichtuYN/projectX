...
import DropzoneComponent from "../../company/(component)/DropzoneComponent";
import DialogImage from "../../company/(component)/DialogImage";
import identification from "../../../../../../../public/images/identification.jpg";
...
const FrontIdCard = ({ form, files, setFiles }: Props) => {
  return (
    <FormFieldComponent
        ...
        <Card className=" border rounded-lg">
          ...
          <div className="flex p-2 items-start">
            ...
            <div className="space-y-2 flex items-center w-1/2 justify-center">
              <DialogImage image={identification} />
            </div>
          </div>
        </Card>
      )}
