          ...
          <div className="col-span-2 flex flex-col items-center gap-5">
            <Card className="w-full">
              <CardHeader>
                ...
                <CardDescription className="flex items-center gap-36 pt-2">
                  <span className="flex items-center gap-2">
                    <CircleDollarSign className="w-9 h-9 text-secondaryColor" />
              ...
              <CardFooter className="flex items-center gap-3">
                <Button className="flex items-center font-semibold w-4/5">
                  <Send />
                  <p>Ứng tuyển ngay</p>
                </Button>
                <Button
          ...
          <div className="col-span-1 flex flex-col gap-4">
            <Card className="w-full">
              <CardHeader>
                ...
                <CardDescription className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="w-2/3 text-black">22-99 nhân viên</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="flex items-center gap-2 w-1/3">
                    ...
                    <p className="w-2/3 text-black">Bất động sản</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="flex items-center gap-2 w-1/3">
                    ...
                    <p className="w-2/3 text-black overflow-hidden text-ellipsis line-clamp-2">
              ...
              <CardFooter className="flex justify-center">
                <Link
                  className="flex items-center justify-center gap-2 text-secondaryColor"
                  href={"/"}
                >
                  Xem trang công ty{" "}
