...
const JobBoardComponent = () => {
  ...
  return (
    <div className=" w-4/5 flex flex-col items-center pt-2 justify-center min-h-[75vh]">
      <div className=" w-full h-full">
        ...
        <div className="lg:flex lg:items-center border-b ">
          ...
          <div className="relative lg:w-3/4 flex lg:justify-end ">
            <Carousel className="w-full lg:w-3/4">
              <CarouselContent className="flex flex-row items-center lg- justify-start">
                <CarouselItem className="md:flex hidden md:justify-center  space-x-2 ml:20 md:pl-0">
                  <Button
                    variant="secondary"
                ...
                <CarouselItem className="flex md:hidden justify-center space-x-2 ml:20 md:pl-0">
                  <Button
                    variant="secondary"
                    className="rounded-full font-medium"
                  >
                ...
                <CarouselItem className="md:hidden justify-center  flex space-x-2">
                  <Button variant="ghost" className="rounded-full font-medium">
                    Miền Bắc
                  </Button>
                  <Button variant="ghost" className="rounded-full font-medium">
