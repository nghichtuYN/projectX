              ...
              <Card key={i}>
                <div className="p-4">
                      ...
                      <HoverCard>
                        ...
                        <HoverCardContent className=" w-96  h-[500px]  rounded-md">
                          ...
                          <div className="flex w-full gap-2 mt-2 shadow-md ">
                            <Button
                              className="w-1/3 text-secondaryColor font-semibold border-secondaryColor hover:bg-secondaryColor hover:text-white"
                              variant={"outline"}
                            >
                              Ứng tuyển
                            </Button>
                  ...
                  <div className="mt-4 flex items-center justify-between gap-2">
                    ...
                    <Heart className="h-5 w-5 text-secondaryColor  " />
                  </div>
                </div>
              </Card>
            ))}
